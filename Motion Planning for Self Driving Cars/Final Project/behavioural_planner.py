...
class BehaviouralPlanner:
    ...
    def transition_state(self, waypoints, ego_state, closed_loop_speed):
        ...
        if self._state == FOLLOW_LANE:
            ...
            # TODO: INSERT YOUR CODE BETWEEN THE DASHED LINES
            # ------------------------------------------------------------------
            goal_index = self.get_goal_index(self.waypoints,self.ego_state,closest_len,closest_index)
            # ------------------------------------------------------------------
            ...
            x_g = waypoints[self._goal_index][0]
            y_g = waypoints[self._goal_index][1]
            v_g = waypoints[self._goal_index][2]
            #v_goal = ego_state[3]
            #v_goal = closed_loop_speed
            
            self._goal_state = [x_g, y_g, v_g]
            # ------------------------------------------------------------------
